#ifndef MISSION_MANAGER_EXAMPLE_H
#define MISSION_MANAGER_EXAMPLE_H
...
class mission_manager_example : public mission_manager_base
{
public:
  mission_manager_example();
private:
...
#endif // MISSION_MANAGER_EXAMPLE_H
